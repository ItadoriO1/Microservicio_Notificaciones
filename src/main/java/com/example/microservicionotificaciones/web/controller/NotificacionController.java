...
public class NotificacionController {
    ...
    @GetMapping("/all/{id}")
    public ResponseEntity<Iterable<NotificacionDTO>> getNotificacionesById(@PathVariable @Parameter(description = "ID de la notificacion") Long id) {
        Iterable<NotificacionDTO> notificaciones = notificacionService.findAllByUsuarioId(id);
        return ResponseEntity.ok(notificaciones);
    }
}
